import os
def positionConfusing(cars):
    points_file = open(os.path.join(os.getcwd(), 'materials', 'points.txt'), 'r')
    matrix_file = open(os.path.join(os.getcwd(), 'materials', 'linprog' + str(epsilon) + '.txt'), 'r')
